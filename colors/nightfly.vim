...
exec 'highlight LineNr guibg=NONE guifg=' . s:steel_blue
...
exec 'highlight SignColumn guibg=NONE guifg=' . s:green
...
exec 'highlight NightflyWhiteAlert guibg=NONE guifg=' . s:white
exec 'highlight NightflyCadetBlueAlert guibg=NONE guifg=' . s:cadet_blue
exec 'highlight NightflyYellowAlert guibg=NONE guifg=' . s:yellow
exec 'highlight NightflyOrangeAlert guibg=NONE guifg=' . s:orange
exec 'highlight NightflyRedAlert guibg=NONE guifg=' . s:red
exec 'highlight NightflyPurpleAlert guibg=NONE guifg=' . s:purple
exec 'highlight NightflyBlueAlert guibg=NONE guifg=' . s:blue
exec 'highlight NightflyEmeraldAlert guibg=NONE guifg=' . s:emerald
